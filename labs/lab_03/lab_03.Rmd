...
A2: 25301 is the zip code with the highest total amount of loans by dollar value. JACKSON KELLY PLLC got the largest loan in that zip code. 

The zip code - 25301 - is in western West Virginia. 
The business' loan was for $5,068,472.
The forgiveness amount was $5,126,618.64. 
The forgiveness amount is larger than the loan amount because of interest.
...
All of these businesses are car dealerships, helping West Virginians with their next car purchases. 
...
dutch_miller <- cleaned_zip_wv_loans %>% 
  filter(name == "DM Motors" | name == "Dutch Miller Chevrolet" | name == "Dutch Miller of Charleston" | name == "Dutch Miller of Charlotte" | name == "Dutch Miller Subaru") 
