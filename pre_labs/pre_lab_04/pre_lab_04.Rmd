...
**Answer** Yes, all three files have the same column structure.
...
**Answer** There are 190,787 rows in maryland_ppp.
...
**Answer** There are still 190,787 rows. That means each company has a unique naics code.
...
**Answer** The error message I receive is "Error: Can't join on `x$zip` x `y$zip` because of incompatible types." It means that the PPP & NAICS data is character, but the ZCTA data is numeric. 
...
**Answer** Yes, now every row has demographic data. 
...
**Answer** The number of PPP loans that went to ZCTAs with more than 50% non-Hispanic Black population is 41,968, the average of those loans is 55,546.84 and the median is 19,949.
...
**Answer** The number of PPP loans that went to ZCTAs with more than 50% non-Hispanic white population is 112,056, the average of those loans is 89,194.67, and the median is 20,833.
...
**Answer** The number of PPP loans that went to ZCTAs with more than 50% non-Hispanic Black population, grouped by rural status is 145, the average of those loans is 44,815.22 and the median is 19,064.57. And by urban status, the number of loans is 41,823, the average is 55,584.05 and the median is 19,950.
...
**Answer** The number of PPP loans that went to ZCTAs with more than 50% non-Hispanic white population, grouped by rural status is 18,083, the average of those loans is 74,463.32 and the median is 20,833. By urban status the number of loans is 93,973, the average is 92,029.39 and the median is 20,833. (Oh interesting, the median is the same for both rural and urban)
