...
**Answer** The datatype for date_approved is character and the datatype for CleanDate is date-time.
...
```
What is the datatype for `date_approved` (it's just to the right of the column name)? Put your answer in the space below.
**Answer** The datatype for 'date_approved' is date.
...
**Answer** April 2020 saw the most application - 45,042 applications.
