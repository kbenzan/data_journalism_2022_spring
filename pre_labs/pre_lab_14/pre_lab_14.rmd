...
**Answer** The dataframe includes all the tweets tweeted during covid by public officials. The dataframe incorporates the username, the content, the date, the time, the name of the user, their state, their political affiliation and title.
...
**Answer** The unique function selects the distinct figures out of a list. That function just picked out one "dog" and "cat."
...
**Answer** The unnest_tokens function picks out individual words from the content column.
...
**Answer** The graphic shows the top used words in the covid tweets. The top words used are articles, conjunctions, versions of the verb 'to be' and different versions of covid, such as "19," "coronavirus" and "covid19." One word that stands out is "amp." I'm not quite sure why that word would be so popular. 
...
**Answer** These results are much more interesting than that above because these results exclude all stop/insignificant words. Now we can see that the most used words have much to do with covid, health and medical care.
...
**Answer** The most used words across the two dataframes are very similar. All are about covid and the global pandemic.
...
**Task** Run the following code and describe the results.
**Answer** The results show the most used phrases for 2020 tweets. Again these results include phrases that are about covid and health care. One phrase stands out though - "town hall" is ranked fifth. "Town hall" isn't affiliated with covid or health care.
...
**Task** Run the following code and describe the results.
**Answer** The results show the most used phrases for 2021 tweets. Again these results are all about covid and health care.
...
**Task** Run the following code and describe the results.
**Answer** We can see the difference between the parties and about what they tweet. The majority are the same; however, there are a couple distinctions between the two parties. One unique phrase is "american people", whereas for the other party "social distancing" and "relief package" are popular. These phrases in particular can insinuate the motives/goals of each party.
...
**Task** Run the following code and describe the results.
**Answer** The results show the top phrases for both 2020 and 2021 for Republican public officials. The majority again is about covid and the pandemic. But, there are a couple differences between the two years. In 2020, "president trump" was a popular phrase, probably surrounding the election. Then in 2021, "illegal immigrants" and "joe biden" popped up, probably surrounding Biden's changes within the United States immigration policy. 
...
**Answer** It was interesting in 2020 that Trump was categorized as positive. Especially with a politician like Trump who is so polarizing I think the sentiment around him would depend on your political affiliation. Another interesting categorization is the word enough as positive. With a word like enough its sentiment is completely dependent on context. It could be "I'm not good enough" which has a negative connotation. Or, "I can't thank you enough" which has a positive connotation.
