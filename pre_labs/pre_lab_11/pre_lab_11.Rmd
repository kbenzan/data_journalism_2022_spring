...
**Answer** A list of different files named "Hospitals"
...
**Answer** I see a dataframe of "Hospitals.shp" including the dimension, rows and columns. We can see the names of the 33 columns and some of the data.
...
**Answer** I see a similar data frame as above, but the hospitals are limited to Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A data frame with data that answers the question: What kind of hospitals do we have? For example, there are 50 general acute care hospitals in Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A data frame that shows the points for the 50 general acute hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A grid that plots the 50 hospitals based on their coordinates. The points almost take up the shape of Maryland the state.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Got it. Tigris installed.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A data frame of counties with the geographic elements.
```{r}
counties <- counties() 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A data frame limited to the Maryland counties and their geographic elements.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map graphed on their coordinates. We can actually see the boundaries Maryland with county boundaries. But, it fills in the water parts.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We see the hospital points over the county map. Most of the hospitals are in Baltimore.
...
# order matters - build from bottom to up
```
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** With the hospital-county layered map, now the hospitals are organized by the number of beds. The lighter the point, the more beds the hospital contains.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A data frame that shows the 50 general acute care hospitals from the shapefile.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We see a tibble that shows the total number of beds per county
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A tibble that shows the population for each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A data frame that incorporates the geometry shapes (multipolygon) as well. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Both the tibble that shows the total number of beds per county and the data frame with the geometry data.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A data frame with only the county, population and geometry information
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A joined data frame with county, population, number of beds and geometry information.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Now the NA's read as 0 for Queen Anne's and Caroline counties
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This data frame now has a new column that reads beds_per_100k. It's calculated by "total_beds/population*100000"
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map of Maryland counties that is ranked by the number of beds per 100,000. Baltimore City has the most - over 700 beds.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This map's ranking system is much clearer and easier to understand with 4 distinct colors. But, the system is not "grainy."
...
**Answer** A map with a "grainy" scale. The larger counties are lower on this scale, but the least populated counties are higher. It was surprising to see Montgomery and Prince George's counties so low on the scale. Baltimore City is unique in the sense that it's a small county but highly populated; still, the city is ranked one of the highest county with number of beds per 100,000. Central Maryland generally ranks lower on the scale compared to Eastern and Coastal Maryland. 
