...
**Answer** First, we create a new dataframe named "maryland_ppp_top_counties." Then, we group the data by county name, add all the loans and finally organize the counties via descending order. Lastly, we asked R to show the first 10.
...
**Answer** I see an empty gray box.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** A bar chart, showing the total number of loans per county.
...
**Answer** The bars are in ascending order
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** We've switched the x and y axes, so the bars are horizontal
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The background color is white, instead of gray. So we can see the lines more clearly.
...
**Answer** We have a nice blue background now like the Economist
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** We've added a title and a caption reading "source: SBA PPP loan database". We've also cleaned up the label names.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A chart that reads the total number of loans for each approved date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A line chart with the above data
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** This line chart is broken down by month
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** This line chart adjusted how readable the x axis is. Now we can read each month and year easily.
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
...
# lowercase b - abbreviated month
# uppercase B - full spelled out month
# Y - full year
```
